...
3. Configure the app:
   ...
   - **Homepage URL**: `https://armageddontest.icu`
...
- Production site: `https://armageddontest.icu`
...
**CRITICAL NOTE**:
- Use the Armageddon Supabase project.
- Use the Armageddon GitHub OAuth app.
- Do NOT use OmniHub OAuth credentials.
- Do NOT use OmniHub Supabase settings.
